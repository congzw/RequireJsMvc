...
using MvcWebViewPage = System.Web.Mvc.WebViewPage;

namespace DemoMvc.Extensions
{
    public static class HtmlRenderExtensions
    {
        //http://stackoverflow.com/questions/5433531/using-sections-in-editor-display-templates/14127332#14127332
        ...
        private class DelayedInjectionBlock : IDisposable
        {
            ...
            public DelayedInjectionBlock(HtmlHelper helper, string identifier = null, string isOnlyOne = null)
            {
                ...
                var webViewPage = ((MvcWebViewPage) this.helper.ViewDataContainer);
            ...
            public void Dispose()
            {
                ...
                var content = ((MvcWebViewPage)this.helper.ViewDataContainer).OutputStack;
